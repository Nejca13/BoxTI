    ...
    <div className={styles.container} id='_1'>
      ...
      <section className={styles.mainHero} id='hero'>
        ...
        <div className={styles.preDescription}>
          <p>Servicios Informaticos, para pequeñas y grandes empresas</p>

          <button>
            <a
              className={styles.btnHablanos}
      ...
      <section className={styles.about} id='about'>
        ...
        <div className={styles.aboutDescription}>
          <p>
            ...
            de PC, Notebook y consolas de video juegos.
            <br />
      ...
      <section>
        ...
        <div className={styles.pcFix}></div>
      ...
      <p className={styles.copy}>&#169; {new Date().getFullYear()} Nejca</p>
      <WhatsAppButton
        icon={faWhatsapp}
        bgColor='#00bb2d'
        bottom='15px'
